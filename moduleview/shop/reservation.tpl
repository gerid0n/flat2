...
<form method="POST" action="{$router->getUrl('shop-front-reservation', ["product_id" => $product.id])}" class="form-style modal-body reserve-form">
    ...
    <div class="form-group">
        ...
        <div class="quantity rs-amount">
            <input value="{$reserve.amount}" name="amount" class="rs-field-amount">
            <div class="quantity-nav">
                ...
                <div class="quantity-button quantity-up rs-inc">+</div>
                <div class="quantity-button quantity-down rs-dec">-</div>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <label class="label-sup"><small>{t}или{/t}</small> {t}E-mail{/t}</label>
