    ...
    <div class="cart-wrapper hover-wrapper">
        <div class="cart-block">
            <div class="cart-block-wrapper">
                    ...
                    <div class="t-drop-account">
                        ...
                        <div class="t-drop-account_wrap">
                            ...
                            {if $use_personal_account}
                                <span class="t-drop-account__balance">Баланс:&nbsp;{hook name="users-blocks-authblock:balance" title="{t}Блок авторизации:баланс{/t}"}<a href="{$router->getUrl('shop-front-mybalance')}">{$current_user->getBalance(true, true)}</a>{/hook}</span>
                            {/if}
                ...
                {else}
                    <div class="icon-account">
                        <a href="{$router->getUrl('users-front-auth', ['referer' => $referer])}" title="{t}Войти или зарегистрироваться{/t}" class="rs-in-dialog">
